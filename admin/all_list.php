...
<div class="modal fade" id="admin_profile" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>List of Students Recieved their Modules</h1>
      <nav>
        <ol class="breadcrumb">
         ...
         <div class="col-12">
                <div class="card-body">
                  <table class="table table-borderless datatable">
                    <thead>
                      <tr>
                      <th scope="col">School ID number</th>
                        ...
                        <?php 
                          $get_modules = mysqli_query($conn, "SELECT DISTINCT stud_id_num FROM modules_to_get");
                          while($mod_row = mysqli_fetch_array($get_modules)){

                                    $my_sid = $mod_row['stud_id_num'];

                                    $get_name = mysqli_query($conn, "SELECT * FROM students WHERE school_id='$my_sid'");
                                    while($myrow = mysqli_fetch_object($get_name)){
                                        $mysid = $myrow -> school_id;
                                        $myfn = $myrow -> fn;
                                        $myln = $myrow -> ln;
                                        $myyr = $myrow -> yr_level;
                                        $mysec = $myrow -> section;
                                    ...
                                    $get_d = mysqli_query($conn, "SELECT * FROM modules_to_get WHERE stud_id_num='$my_sid'");
                                    while($myrow2 = mysqli_fetch_object($get_d)){
                                        $mydate = $myrow2 -> date_get;
                                        $admin = $myrow2 -> encoded_by;
                                    ...
                                    <td><?php echo $myfn.' '.$myln;?></td>
                                    <td><?php echo $mysec;?></td>
                                    <td><?php echo $myyr;?></td>
