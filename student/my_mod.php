                  ...
                  <table class="table table-borderless datatable">
                    <thead>
                      <tr>
                        ...
                        <?php 
                          $get_modules = mysqli_query($conn, "SELECT * FROM modules_to_get WHERE stud_id_num='$sid'");
                          while($mod_row = mysqli_fetch_array($get_modules)){

                          
                        ?>
                         <tr>
                            <td><b><?php echo $mod_row['subject_code'];?></b></td>

                            <?php
                                $stat1 = $mod_row['status'];
                                if($stat1 == "Pending"){
                                    ?>
                            <td><b><span class="text-danger"><?php echo $mod_row['status'];?></b></a></td>
                                    <?php
                                    }else{
                                        ?>
                            <td><b><span class="text-success"><?php echo $mod_row['status'];?></b></a></td>
                                     <?php
                                    }
                                    ?>
                            ...
                            <?php
                                ...
                                if($stat1 == "Pending"){
                                    ?>
                            <td><a href="remove.php?id=<?php echo $mod_row['id']; ?>" onclick="return confirm('Do you want to delete this Module?')"> 
